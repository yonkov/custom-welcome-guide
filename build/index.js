...
const WelcomeGuideList = props => {
  ...
  return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["Fragment"], null, posts.length > 0 && parentPosts.map((post, index) => Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("div", {
    class: "guide-list"
  }, index == 0 && parentPosts.length == 1 ? '' : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])("span", null, index + 1 + '.'), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__["Button"], {
    className: "guide-btn",
    key: index,
    onClick: () => {
      setOpen(true);
