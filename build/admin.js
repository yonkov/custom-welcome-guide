...
class App extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  componentDidMount() {
    ...
    fetch(custom_welcome_guide_script_params.rest_url + 'wp/v2/guides').then(response => response.json()).then(posts => {
      this.setState({
        posts: posts
      });
    });
  ...
  dropdownWithOptions(posts) {
    const options = [{
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('None', 'custom-welcome-guide'),
      value: ''
    }];
    posts.forEach(post => {
      if (post.parent == 0) {
        options.push({
          label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])(post.title.rendered, 'custom-welcome-guide'),
          value: post.id
        });
      }
    });
  ...
  render() {
    ...
    if (!isAPILoaded) {
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h2", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["Icon"], {
        icon: "admin-plugins"
      }), " ", Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Welcome Guide Options', 'custom-welcome-guide')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["PanelBody"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["Spinner"], null))));
    }

    return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["Fragment"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])("h2", null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["Icon"], {
      icon: "admin-plugins"
    }), " ", Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Welcome Guide Options', 'custom-welcome-guide')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["PanelBody"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["PanelRow"], null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(_wordpress_components__WEBPACK_IMPORTED_MODULE_1__["ToggleControl"], {
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Show guides in the Post editor', 'custom-welcome-guide'),
      ...
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Show guides in the Page editor', 'custom-welcome-guide'),
      ...
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Show guides in Custom Post Types', 'custom-welcome-guide'),
      ...
      help: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])("Choose a Featured Guide if you want to replace the Block Editor's default Welcome Guide Modal that pops up when you open the Block Editor for the first time.", 'custom-welcome-guide'),
      label: Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Featured Guide', 'custom-welcome-guide'),
      onChange: featuredPostId => this.setState({
        featuredPostId
      }),
      options: posts && this.dropdownWithOptions(posts),
      ...
      onClick: () => {
        ...
        settings.save();
        Object(_wordpress_data__WEBPACK_IMPORTED_MODULE_4__["dispatch"])('core/notices').createNotice('success', Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Settings Saved', 'custom-welcome-guide'), {
          type: 'snackbar',
          isDismissible: true,
    ...
    }, Object(_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__["__"])('Save', 'custom-welcome-guide')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__["createElement"])(Notices, null));
  }
